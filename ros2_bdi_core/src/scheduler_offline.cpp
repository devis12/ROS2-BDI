...
*/
bool SchedulerOffline::launchPlanExecution(const BDIManaged::ManagedPlan& selectedPlan)
{   
...
/*
    ...
    return true if successful
*/
bool SchedulerOffline::abortCurrentPlanExecution()
{
...
*/
bool SchedulerOffline::tryTriggerPlanExecution(const ManagedPlan& selectedPlan)
{      
    string reschedulePolicy = this->get_parameter(PARAM_RESCHEDULE_POLICY).as_string();
    bool noPlan = noPlanExecuting();
