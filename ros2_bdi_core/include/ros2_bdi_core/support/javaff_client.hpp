...
class JavaFFClient
{
    public:
        ...
        bool launchPlanSearch(const ros2_bdi_interfaces::msg::Desire& fulfilling_desire, const std::string& problem, const int& interval, const int& max_empty_search_intervals);
