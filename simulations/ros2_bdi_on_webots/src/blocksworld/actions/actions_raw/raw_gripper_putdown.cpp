...
class GripperPutdownRaw : public plansys2::ActionExecutorClient
{
    public:
        GripperPutdownRaw()
        : plansys2::ActionExecutorClient("gripper_putdown", std::chrono::milliseconds(333))
        {
            //this->declare_parameter(ROBOT_NAME_PARAM, ROBOT_NAME_PARAM_DEFAULT);
            
            this->set_parameter(rclcpp::Parameter("action_name", "gripper_putdown"));
            /*
...
int main(int argc, char ** argv)
{
  ...
  auto actionNode = std::make_shared<GripperPutdownRaw>();
